...
public class FaceDivision {
	...
	public static List<Integer> getFaceProportion(List<AccuratePoint> points) {
		...
		List<Integer> result = Util.getReduction(tmp);
		return result;
	}
	...
	public static Map<String , Ratio> getRatio(List<AccuratePoint> points){
		...
		List<Integer> result1 = Util.getReduction(tmp1);
		...
		List<Integer> result2 = Util.getReduction(tmp2);
		...
		List<Integer> result3 = Util.getReduction(tmp3);
